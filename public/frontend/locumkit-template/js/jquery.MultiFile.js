			...
			.each(function () {
				...
				MultiFile.addToList = function (slave, slave_count, files) {
					...
					$("#close_reciept").click(function(){
						...
						$(slave).remove();
						$("div#receipt_img div.MultiFile-label").remove();
						...
						//# End Event!
						$("#close_reciept").hide(500);
						$("div#receipt_img input[type=file]").show(500);
						$("div#receipt_img .upload_img").show(500);
					});
