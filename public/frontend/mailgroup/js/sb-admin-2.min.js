...
!function (t) {
    ...
    t("#sidebarToggle, #sidebarToggleTop").on("click", function (o) {
        ...
        if (t(".sidebar").hasClass("toggled") && t(".sidebar .collapse") && typeof t(".sidebar .collapse") == "object" && typeof t(".sidebar .collapse").collapse == "function") {
            t(".sidebar .collapse").collapse("hide")
        }
    }),
        t(window).resize(function () {
            if (t(window).width() < 768 && t(".sidebar .collapse") && typeof t(".sidebar .collapse") == "object" && typeof t(".sidebar .collapse").collapse == "function") {
                t(".sidebar .collapse").collapse("hide")
            }
        }),
