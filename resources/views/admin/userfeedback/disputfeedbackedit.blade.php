...
@section('content')
    ...
    <div class="main-container container">
        ...
        <div class="page-content" style="margin-top: -10px">
            <form class="relative form-horizontal" action="/admin/config/user/feedback/user-feedback/edit/1" method="post"
                enctype="application/x-www-form-urlencoded">
                <inpute type="hidden" name="user_type" value="2">
                    <div class="form-group">
                        <label class="required control-label col-lg-2" for="feedback_from">Feedback From</label>
                        <div class="col-lg-10">
                            <p class="form-control" readonly="" style="text-transform: capitalize;">Isidro Steuber (3)
                            </p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <p class="form-control" readonly="" style="text-transform: capitalize;">Francesco Powlowski
                                (2)</p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            ...
                            <div id="details-feedback" style="display:none;">
                                <div class="feedback-qus-ans">
                                    <p class="qus"><span>Qus. 1)</span>Was the store/equipment as described in the job
                                        advert?</p>
                                ...
                                <div class="feedback-qus-ans">
                                    <p class="qus"><span>Qus. 2)</span>How would you rate the employer's professionalism?
                                    </p>
                                    <div class="user-rating">
                                ...
                                <div class="feedback-qus-ans">
                                    <p class="qus"><span>Qus. 3)</span>How satisfied were you with the the team and
                                ...
                                <div class="feedback-qus-ans">
                                    <p class="qus"><span>Qus. 4)</span>How would you rate the stores' time-keeping and
                                        diary management?</p>
                                    <div class="user-rating">
                                ...
                                <div class="feedback-qus-ans">
                                    <p class="qus"><span>Qus. 5)</span>Overall how satisfied were you with the employer?
                                    </p>
                                    <div class="user-rating">
