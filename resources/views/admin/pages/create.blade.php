...
@section('content')
    <div class="main-container container">
        ...
        <div id="breadcrumbs" class="breadcrumbs">
            ...
            <ul class="breadcrumb"> 
                <li>
                    ...
                    <a href="/admin/dashboard">Dashboard</a>s
                </li>
                <li class="active">
        ...
        <div class="page-content">
            ...
            @endif
            <form action="{{ route('admin.page.store') }}" class="relative form-horizontal" novalidate method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <textarea name="description" style="border-radious: 5px !important;" id="descriptions" class="form-control" required></textarea>
