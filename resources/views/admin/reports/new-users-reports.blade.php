        ...
        <div class="page-content" style="margin-top: -10px">
            ...
            <div id="fre-tab">
                <table class="table clickable table-striped table-hover">
                    ...
                    <tbody class="" id="render_locam">
                        @include('admin.reports.new-user-partial')
                    </tbody>
            ...
            <script>
                function getPrint(){
                    ...
                    var sign_up_dates = document.getElementsByName("sign_up_dates[]");
                    ...
                    for (var i = 0; i < firstnameInputs.length; i++) {
                        var entry = {
                            ...
                            cateogry: category[i].value,
                            user_type: user_type[i].value,
                            sign_up_dates: sign_up_dates[i].value,
                        };
                        data.push(entry);
                    }

                    var form = document.createElement('form');
                    form.action = "{{ route('report.newuserreport.export') }}";
                    form.method = 'POST';
