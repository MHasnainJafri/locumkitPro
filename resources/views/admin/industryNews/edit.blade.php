...
<div class="main-container container">
    ...
    <div class="col-lg-12 main-content">
        ...
        <div class="page-content">
            ...
            <div class="col-lg-12">
                <form class="relative form-horizontal" id="myform" novalidate action="{{route('admin.industry.update', $news->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div id="tabs">
                        ...
                        <div id="tabs-1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="slug" class="form-control" id="slug" value="{{$news -> slug}}" required>
                            ...
                            @php
                            $user_type = explode(',', $news -> user_type);
                            $profession = explode(',', $news -> category_id);
                            @endphp
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <div class="col-md-3">
                                        <input type="checkbox" {{ in_array(2, $user_type) ? 'checked' : '' }} name="user_type[]" id="user_type" value="2">
                                        <label class="optional" for="Locums"> Locums</label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" {{ in_array(3, $user_type) ? 'checked' : '' }} name="user_type[]" id="user_type" value="3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="col-md-3">
                                        <input type="checkbox" {{ in_array(9, $profession) ? 'checked' : '' }} name="profession_type[]" id="profession_type" value="9">
                                        <label class="optional" for="Employers"> Audiologists </label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" {{ in_array(1, $profession) ? 'checked' : '' }} name="profession_type[]" id="profession_type" value="1">
                                        <label class="optional" for="Employers"> Dentistry </label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" {{ in_array(10, $profession) ? 'checked' : '' }} name="profession_type[]" id="profession_type" value="10">
                                        <label class="optional" for="Employers"> Dispensing Optician / Contact lens Optician </label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" {{ in_array(8, $profession) ? 'checked' : '' }} name="profession_type[]" id="profession_type" value="8">
                                        <label class="optional" for="Employers"> Domiciliary Opticians </label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" {{ in_array(3, $profession) ? 'checked' : '' }} name="profession_type[]" id="profession_type" value="3">
                                        <label class="optional" for="Employers"> Optometry </label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" {{ in_array(4, $profession) ? 'checked' : '' }} name="profession_type[]" id="profession_type" value="4">
                        ...
                        <div id="tabs-2">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="metatitle" class="form-control" id="metatitle" value="{{$news -> metatitle ?? ''}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="metadescription" class="form-control" id="metadescription" value="{{$news -> metadescription ?? ''}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="metakeywords" class="form-control" id="metakeywords" value="{{$news -> metakeywords ?? '' }}">
