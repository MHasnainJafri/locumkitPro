...
<div class="main-container container">
    ...
    <div class="col-lg-12 main-content">
        ...
        <div class="page-content">
            ...
            <form class="relative form-horizontal" action="{{route('admin.blog.store')}}" id="myForm" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div id="tabs">
                    ...
                    <div id="tabs-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <div class="col-md-3">
                                    <input type="checkbox" name="category_id" id="category_id_1" value="1" class="category-checkbox">
                    ...
                    <div id="tabs-2">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <span id="metatitleError" style="display: none; color: red;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-2" for="email">Meta Description</label>
                            <div class="col-lg-10">
                                <input type="text" name="metadescription" class="form-control" id="metadescription">
                                <span id="metadescriptionError" style="display: none; color: red;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <span id="metakeywordsError" style="display: none; color: red;"></span>
                            </div>
                        </div>
                    </div>
                </div>
