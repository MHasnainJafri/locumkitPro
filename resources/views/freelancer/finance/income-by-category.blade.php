                ...
                <div class="white-bg contents">
                    <section class="text-left">
                        <div class="col-md-12 pad0">
                            <div class="text-capitalize finance-page-head text-center">Income By Category</div>
                        </div>
                                        ...
                                        <div class="oneyear canvas-scroll-x">
                                            <div class="mapdiv topyear">
                                                <div class="canvascover">
                                                    <div class="col-md-12">Total Income by categories for year {{ $filter_year }}-{{ $filter_year + 1 }}</div>
                                        ...
                                        <div class="form-group add_item_form form-inline marb0">
                                            <select name="category" class="form-control pull-right" onchange="this.form.submit()">
                                                ...
                                                @foreach ($categories as $key => $category)
                                                    <option @selected($category_filter == $key) value="{{ $key }}">{{ $category }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                                ...
                                                @foreach ($income_records as $record)
                                                    <tr>
                                                       ...
                                                       <td class="col-md-1" data-order="{{ $record->job_date }}">
                                                        ...
                                                        <td class="col-md-1"> {{ $record->get_income_type() }} </td>
                                                        <td class="col-md-1">
