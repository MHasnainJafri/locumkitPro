                ...
                <div class="white-bg add-expense contents">
                    ...
                    <section class="add_item text-left">
                        <div class="col-md-12 pad0">
                            <div class="finance-page-head text-center">Update expense</div>
                        </div>
                        <div class="col-md-12 pad0"></div>
                        <div class="col-md-12 pad0">

                            <form role="form" id="expense-form" action="{{ route('freelancer.edit-expense-update', $expense->id) }}" enctype="multipart/form-data" method="POST" onsubmit="validexpenseform()"
                                  class="add_item_form form-inline">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <select name="ex_job_type" id="ex_job_type" class="form-control" required="required">
                                                ...
                                                <option @if ($expense->job_type == '1') selected @endif value="1">Website</option>
                                                <option @if ($expense->job_type == '2') selected @endif value="2">Private</option>
                                                <option @if ($expense->job_type == '3') selected @endif value="3">Other</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7"><input type="number" name="ex_job_id" id="ex_job_id" value="{{ $expense->job_id }}" placeholder="Please enter job no." class="form-control"></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group">
                                                ...
                                                <input type="date" value="{{ $expense->job_date }}" name="ex_job_date" class="form-control" required autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    £ </span>
                                                <input type="text" name="ex_job_cost" value="{{ $expense->job_rate }}" id="ex_job_cost" placeholder="Please Enter Amount" class="form-control" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <textarea type="text" name="ex_job_description" id="ex_job_description" placeholder="Enter description of expense" class="form-control">{{ $expense->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                        ...
                                        <div class="col-md-7">
                                            <select name="ex_category" id="ex_category" class="form-control" required>
                                                ...
                                                @foreach ($expense_categories as $category)
                                                    <option value="{{ $category->id }}" @if ($expense->expense_type_id == $category->id) selected @endif> {{ $category->expense }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <div class="checkbox">
                                                <label for="ex_bank">
                                                    <input name="ex_bank" type="checkbox" id="ex_bank" @if ($expense->is_bank_transaction_completed) checked @endif>
                                ...
                                <div class="col-md-12 new_bank_date no_field" @if (!$expense->is_bank_transaction_completed) style="display:none" @endif id="exbank_date">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group date form_date" autocomplete="off">
                                                ...
                                                <input type="date" class="form-control" value="{{ $expense->bank_transaction_date }}" name="ex_bank_date" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group text-center">
                                        <button type="submit" name="expense_submit" id="expense_submit" value="expense_submit" class="read-common-btn grad_btn">Update</button>
